...
function CategoryCardAd({ category, index }: Props) {
  return (
    <Link
      ...
      key={category._id}
    >
      <div className="ease-[cubic-bezier(0.23,1,0.32,1)] relative aspect-square w-full overflow-hidden rounded-full bg-white transition-all duration-700 group-hover:rounded-full group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
