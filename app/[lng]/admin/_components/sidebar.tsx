...
function Sidebar() {
  ...
  return (
    <aside className="relative flex h-screen w-[300px] flex-col border-r border-white/10 bg-slate-950 backdrop-blur-2xl">
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="border-t border-white/10 p-5">
          <div className="rounded-2xl bg-white/5 p-4 shadow-xl ring-1 ring-white/10 backdrop-blur-xl">
            ...
            <Button className="mt-4 h-9 w-full rounded-xl bg-gradient-to-r from-pink-500 to-indigo-500 text-sm font-medium text-white transition-all duration-300 hover:opacity-90 hover:shadow-lg">
              Chiqish
              <LogOut size={16} />
            </Button>
          </div>
