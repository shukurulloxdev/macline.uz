  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-3 rounded-2xl bg-pink-50 p-4">
        <ShieldCheck size={18} className="mt-0.5 flex-shrink-0 text-pink-600" />
        <div>
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {activeFiltersCount > 0 && (
              <span className="absolute -right-1.5 -top-1.5 flex h-[18px] w-[18px] items-center justify-center rounded-full bg-pink-600 text-[9px] font-black text-white">
                {activeFiltersCount}
              </span>
            )}
          </button>
      ...
      <div className="flex items-start gap-4">
        {/* Desktop sidebar */}
        <aside className="hidden w-[250px] flex-shrink-0 rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm md:block">
        ...
        {mobileFilterOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 z-50 max-h-[90vh] overflow-y-auto rounded-t-[28px] bg-white px-5 pb-10 pt-3 md:hidden"
            >
