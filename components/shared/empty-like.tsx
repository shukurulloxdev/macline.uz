...
export default function EmptyLike() {
  return (
    <div className="flex flex-col items-center justify-center py-10 text-center">
      ...
      >
        Sevimli mahsulot <span className="text-pink-600">yo&apos;q!</span>
      </motion.h1>
      ...
      >
        Yoqtirgan mahsulotlarni yurak belgisiga bosib saqlang
      </motion.p>
